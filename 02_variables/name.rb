...
#     of the user 10 times. You must do this without 
#     explicitly writing the puts method 10 times in a row. 
#     Hint: you can use the times method to do something 
#     repeatedly.

10.times { puts name }

# 4.  Modify name.rb again so that it first asks the user 
#     for their first name, saves it into a variable, and 
#     then does the same for the last name. Then outputs 
